<script>
	...
	let steps = [
        {
            name: "KcaMarket store",
            icon: "fa-solid fa-cart-shopping",
            description:
            	"KcaMarket is a merchandising store created with React, Node.js + Express.js and MongoDB to allow users to view products and purchase and has a dashboard that helps the Admin to manage orders and deliveries",
        },
        {
            name: "Utlimate Todos",
	...
	<section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
		<div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
			<h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
				Hi! I'm <span class="poppins text-violet-400">Hassan </span> Munene
				<br />Full Stack 
				<span class="poppins text-violet-400">Developer</span>
			</h2>
			<p class="text-base sm:text-lg md:text-xl">
				My <span class="text-violet-400">favourite tech</span> includes Javascript
				, TailwindCSS, Node.js + Express.js & PostgressSQL or Firebase/Firestore!
			</p>
			<button class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950 cursor-pointer">
				<div class="absolute top-0 right-full w-full h-full bg-violet-400 opacity-200 group-hover:translate-x-full z-0 duration-200"></div>
